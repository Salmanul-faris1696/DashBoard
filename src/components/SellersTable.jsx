...
function SellersTable() {
  ...
  return (
    <div className='m-3 rounded-lg bg-blue-300 border shadow-gray-500 shadow-md overflow-auto'>
      <div>

      <div className='mt-3 ml-3 font-bold'>
            <p className='flex items-center gap-3'>
                SELLERS TABLE <PiUsersThreeFill size={25}/>
            </p>
        </div>
      <div className=' m-3 rounded-full  w-[52px] h-[52px] flex bg-blue-500 float-right '>
